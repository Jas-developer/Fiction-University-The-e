...
class MyNotes {
  ...
  async createNote(e, ulElement) {
    try {
      ...
      const res = await axios__WEBPACK_IMPORTED_MODULE_0___default().post(postUrl, noteData, {
        headers: {
  ...
  async UpdateNote(e) {
    try {
      ...
      // Sending updated data / Updating data
      const res = await axios__WEBPACK_IMPORTED_MODULE_0___default().post(postUrl, updatedValue, {
        headers: {
          'X-WP-Nonce': universityData.archive_routes.nonce
        }
      });
  ...
  async deleteNote(e) {
    try {
      ...
      const noteId = parentCard.getAttribute('data-id');
      const postUrl = universityData.archive_routes.root_url + `/wp-json/wp/v2/note/${noteId}`;
      const res = await axios__WEBPACK_IMPORTED_MODULE_0___default()["delete"](postUrl, {
        headers: {
          'X-WP-Nonce': universityData.archive_routes.nonce
        }
      });
...
class Search {
  ...
  getResults() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default().getJSON(`${universityData.archive_routes.root_url}/wp-json/university/v1/search?term=` + this.searchField.val(), results => {
  ...
  addSearchHTML() {
    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(".search-overlay").length === 0) {
